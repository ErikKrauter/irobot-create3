...
private:
    ...
    using IrMsg = irobot_create_msgs::msg::IrIntensityVector;
    ...
    void ir_intensity_callback(IrMsg::ConstSharedPtr msg);
    ...
    rclcpp::Subscription<IrMsg>::SharedPtr m_ir_subscription;
